...
/**
 * This class implements Token and Operator interface so that a Divide object
...
public class Divide implements Token, Operator{
    ...
    /**
     * @return the precedence of Divide object as an integer
     */
    ...
    /**
     * Handle the Divide object: if the next token is an operator, pop and append to the postfix string every
