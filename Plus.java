...
/**
 * This class implements Token and Operator interface so that a Plus object
...
public class Plus implements Token, Operator {
    ...
    /**
     * @return the precedence of Plus object as an integer
     */
    ...
    /**
     * Handle the Plus object: if the next token is an operator, pop and append to the postfix string every
