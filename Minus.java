...
/**
 * This class implements Token and Operator interface so that a Minus object
...
public class Minus implements Token, Operator{
    ...
    /**
     * @return the precedence of Minus object as an integer
     */
    ...
    /**
     * Handle the Minus object: if the next token is an operator, pop and append to the postfix string every
