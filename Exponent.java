...
/**
 * This class implements Token and Operator interface so that a Exponent object
...
public class Exponent implements Token, Operator{
    ...
    /**
     * @return the precedence of Exponent object as an integer
     */
    ...
    /**
     * Handle the Exponent object: if the next token is an operator, pop and append to the postfix string every
